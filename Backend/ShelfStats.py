...
## Classifier
model_json = "/data1/naquib.alam/model_31_32_2_sgd.json"
...
imagePath = "/data1/naquib.alam/CIGDataset/ShelfImages"
...
for f in os.listdir(imagePath):
  ...
  #   with open('/data1/naquib.alam/stats/ShelfStatDF_'+str(ui)+'.txt','w') as f:
  #     f.write(statsDf.to_string())

# with open('/data1/naquib.alam/ShelfStat.txt','w') as f:\
#   f.write(shelfStats)
...
with open('/data1/naquib.alam/stats/ShelfStatDFArea_'+str(ui)+'.txt','w') as f:
  f.write(statsDf.to_string())
