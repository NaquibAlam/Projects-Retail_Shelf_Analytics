...
def main(filepath):
	path = os.path.join('/data1/paritosh.pandey/images', filepath)
	...
	try:
		os.mkdir(os.path.join('/data1/paritosh.pandey/static/temp', filepath))
	except OSError as exc:
		try:
			os.mkdir('/data1/paritosh.pandey/static/temp')
			os.mkdir(os.path.join('/data1/paritosh.pandey/static/temp', filepath))
		except OSError as e:
	...
	for i in range(len(stitch_res)):
		res_image_name = '/data1/paritosh.pandey/static/temp/' + filepath + '/result_' + str(i+1) + '.jpg'
		...
		# else:
		try:
			os.mkdir(os.path.join(os.path.join('/data1/paritosh.pandey/static/temp', filepath), "result_"+str(i+1)))
		except OSError as exc:
			if exc.errno != errno.EEXIST:
				raise
			pass
		for index in stitch_indices[i]:
			path = os.path.join(os.path.join('/data1/paritosh.pandey/static/temp', filepath), "result_"+str(i+1))
	...
	# for file in os.path.join("/data1/paritosh.pandey/images", filepath):
	# 	if not os.path.isfile(os.path.join(os.path.join("/data1/paritosh.pandey/images", filepath), file)):
	# 		continue
	# 	os.remove(os.path.join(os.path.join("/data1/paritosh.pandey/images", filepath), file))
	# os.remove(os.path.join("/data1/paritosh.pandey/images", filepath))
